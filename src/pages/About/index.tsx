      ...
      <Hero pageTitle='Sobre'/>
        <Section className='py-12 gap-12'>
          ...
          <div className='flex lg:flex-row flex-col items-center gap-20 lg:mt-4'>
            <img className='w-full rounded-lg shadow-lg object-cover' src={ourTeam} alt="Imagem sobre a empresa" />
            <img className='w-full rounded-lg shadow-lg object-cover' src={team} alt="Imagem sobre a empresa" />
          </div>
